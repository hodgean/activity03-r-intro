...
**Response**: Needed a comma and back slash
...
**Response**: cbind wrong, needed to use c
...
**Response**: Dataframe not a function, data.frame is
...
**Response**: Didn’t give desired result
...
**Response**: % symbol incorrect, $ used instead
...
**Response**: Introduction to R and being able to use basic functions
and create variables. Also be able to pick and and troubleshoot errors.
