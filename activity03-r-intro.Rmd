...
**Response**:
Dataframe not a function, data.frame is
...
**Response**:
Introduction to R and being able to use basic functions and create variables.  Also be able to pick and and troubleshoot errors.
